...
public class UserServiceTest {
	...
	public void shouldThrowExceptionWhenGenderIsInvalid() throws Exception {
		assertThatThrownBy(() -> userService.getAllUsers(Optional.of("asdadads")))
				.isInstanceOf(IllegalStateException.class).hasMessageContaining("Invalid gender");
	}
	...
	public void shouldInsertUser() {
		...
		User anna = new User(userUid, "anna", "montana", Gender.FEMALE, 30, "anna@gmail.com");
